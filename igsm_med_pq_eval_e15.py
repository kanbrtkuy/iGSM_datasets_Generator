...
def generate_igsm_med_dataset(num_samples=4096, seed=42):
    # Set random seed
    fix_seed(seed)
    ...
    # Modified filename to reflect op=15
    file_path = os.path.join(output_dir, 'igsm_med_pq_eval_e15.json')
    ...
    with open(file_path, 'w') as f:
        while count < num_samples:
            ...
            # Check if the number of operations is exactly 15
            if id_gen.op_ != 15:  # op_ is the actual number of operations
                continue
